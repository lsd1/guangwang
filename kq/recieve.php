	...
	if ($ok == 1) { 
		switch($_REQUEST[payResult]){
				case '10':
						...
						$rtnUrl="http://gw.localhost/kq/show.php?msg=success";
						break;
				default:
						$rtnOK=0;
						//以下是我们快钱设置的show页面，商户需要自己定义该页面。
						$rtnUrl="http://gw.localhost/kq/show.php?msg=false";
						break;	
						...
						$rtnOK=0;
						//以下是我们快钱设置的show页面，商户需要自己定义该页面。
						$rtnUrl="http://gw.localhost/kq/show.php?msg=error";
