...
var Index = (function (_super) {
    ...
    function Index() {
        ...
        _this.download_dom = document.getElementById('download');
        _this.android_url = '456.txt';
        _this.ios_url = '123.txt';
        _this.download_dom.download = isiOS ? _this.ios_url : _this.android_url;
        _this.download_btn.addEventListener(egret.TouchEvent.TOUCH_TAP, function () { _this.download_dom.click(); }, _this);
        return _this;
    }
